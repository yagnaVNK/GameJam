...
namespace AmplifyShaderPack
{
	public class ASPStartScreen : EditorWindow
	{
		...
		public static readonly string ChangelogURL = "https://amplify.pt/Banner/ASPchangelog.json";

		private static readonly string HDRPCaralogueURL = "https://wiki.amplify.pt/index.php?title=Unity_Products:Amplify_Shader_Pack/HDRP";
		private static readonly string URPCatalogueURL = "https://wiki.amplify.pt/index.php?title=Unity_Products:Amplify_Shader_Pack/URP";
		private static readonly string BuiltinCatalogueURL = "https://wiki.amplify.pt/index.php?title=Unity_Products:Amplify_Shader_Pack/BuiltIn";
			...
			if( !m_infoDownloaded )
			{
				...
				StartBackgroundTask( StartRequest( ChangelogURL, () =>
				{
					if ( string.IsNullOrEmpty( m_webRequest.error ) )
					{
						...
						try
						{
							temp = ChangeLogInfo.CreateFromJSON( m_webRequest.downloadHandler.text );
						}
						catch ( Exception )
						{
							temp = null;
